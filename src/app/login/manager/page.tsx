...
export default function ManagerLogin() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await authAPI.loginManager({ email, password });
      ...
      <Card className="w-full max-w-md relative z-10 border-2 shadow-2xl bg-card/95 backdrop-blur-sm">
        <CardHeader className="space-y-3 pb-6">
          <div className="flex items-center justify-between">
            ...
            <div className="w-14 h-14 bg-linear-to-br from-accent/20 to-accent/5 rounded-2xl flex items-center justify-center shadow-lg">
