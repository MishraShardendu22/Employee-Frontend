      ...
      <Card className="w-full max-w-md relative z-10 border-2 shadow-2xl bg-card/95 backdrop-blur-sm">
        <CardHeader className="space-y-3 pb-6">
          <div className="flex items-center justify-between">
            ...
            <div className="w-14 h-14 bg-linear-to-br from-secondary/20 to-secondary/5 rounded-2xl flex items-center justify-center shadow-lg">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                required
                className="h-11 border-2 focus:border-secondary"
              />
            </div>
